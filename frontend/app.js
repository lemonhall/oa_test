...
function readWfStepsEditor() {
  ...
  return steps.map((s, i) => ({
    ...
    step_key: String(s.step_key || "").trim(),
    assignee_kind: String(s.assignee_kind || "role"),
    assignee_value: s.assignee_value == null || String(s.assignee_value).trim() === "" ? null : String(s.assignee_value).trim(),
    condition_kind: s.condition_kind == null || String(s.condition_kind).trim() === "" ? null : String(s.condition_kind).trim(),
    condition_value: s.condition_value == null || String(s.condition_value).trim() === "" ? null : String(s.condition_value).trim(),
  }));
}
